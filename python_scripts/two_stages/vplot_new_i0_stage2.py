# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# vplot_new_i0_stage2.py
# V(d*) bar chart for the new_i0 evaluation — two-stage simple DGP.
#
# V is the mean predicted final-stage outcome under each policy's recommended d_star:
#   V(DRE-ML)   = mean(Y_hat_2[i, d_star_2[i]])  from  _new_i0_DRE.csv
#   V(DRE-Param)= mean(Y_hat_2[i, d_star_2[i]])  from  _new_i0_DREp.csv   [optional]
#   V(Naive)    = mean(Y_hat_2[i, d_star_2[i]])  from  _new_i0_NAIVE.csv
#   Observed Y  = mean(Y)  from  new_i0 dataset                            [optional]
#
# Output: _1trt_effect/2stages/images/new_i0/_vplot_k{k}_{flavor}.jpeg
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
images_dir   = os.path.join(script_dir,   '../_1trt_effect/2stages/images/new_i0')
...
def make_vplot(k, flavor_Y, include_drep=True, include_naive=True, include_obs_y=True):
    ...
    ax.set_title(f'V(d*) — Two-Stage new_i0  k={k}  ({flavor_Y})', fontsize=11)

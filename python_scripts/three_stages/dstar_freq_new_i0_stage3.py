# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# dstar_freq_new_i0_stage3.py
# Decision distribution table for the new_i0 evaluation — three-stage simple DGP.
#
# For each (k, flavor) outputs a CSV with four columns:
#   d_star         : combination label, e.g. {0}, {1}, {0,0}, …, {0,0,0}, …
#   observed A     : count in the new_i0 dataset
...
#   Joint (d1, d2, d3)  : {0,0,0}, … {k-1,k-1,k-1}
#
# Output: _1trt_effect/3stages/tables/new_i0/_dstar_freq_k{k}_{flavor}.csv
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
tables_dir   = os.path.join(script_dir,   '../_1trt_effect/3stages/tables/new_i0')
